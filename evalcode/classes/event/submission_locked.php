...
/**
 * The mod_evalcode submission locked event.
 *
...
/**
 * The mod_evalcode submission locked event class.
 *
 * @package    mod_evalcode
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_locked extends base {
     ...
     */
    public static function create_from_user(\evalcode $evalcode, \stdClass $user) {
        $data = array(
    ...
    public function get_description() {
        return "The user with id '$this->userid' locked the submission for the user with id '$this->relateduserid' for " .
            "the evalcodeframework with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissionlocked', 'mod_evalcode');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('locksubmissionforstudent', 'evalcode', array('id' => $user->id, 'fullname' => fullname($user)));
