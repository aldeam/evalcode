...
/**
 * The mod_evalcode batch set marker allocation viewed event.
 *
...
/**
 * The mod_evalcode batch set marker allocation viewed event class.
 *
...
class batch_set_marker_allocation_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventbatchsetmarkerallocationviewed', 'mod_evalcode');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the batch set marker allocation for the evalcodeframework with course " .
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewbatchmarkingallocation', 'evalcode');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call batch_set_marker_allocation_viewed::create() directly, use batch_set_marker_allocation_viewed::create_from_evalcode() instead.');
        }
