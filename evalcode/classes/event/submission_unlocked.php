...
/**
 * The mod_evalcode submission unlocked event.
 *
...
/**
 * The mod_evalcode submission unlocked event class.
 *
 * @package    mod_evalcode
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_unlocked extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionunlocked', 'mod_evalcode');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('unlocksubmissionforstudent', 'evalcode', array('id' => $user->id, 'fullname' => fullname($user)));
