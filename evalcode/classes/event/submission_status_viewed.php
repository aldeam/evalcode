...
/**
 * The mod_evalcode submission status viewed event.
 *
...
/**
 * The mod_evalcode submission status viewed event class.
 *
...
class submission_status_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionstatusviewed', 'mod_evalcode');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has viewed the submission status page for the evalcodeframework with " .
    ...
    protected function get_legacy_logdata() {
        $this->set_legacy_logdata('view', get_string('viewownsubmissionstatus', 'evalcode'));
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call submission_status_viewed::create() directly, use submission_status_viewed::create_from_evalcode() instead.');
        }
