...
/**
 * The mod_evalcode submission duplicated event.
 *
...
/**
 * The mod_evalcode submission duplicated event class.
 *
 * @package    mod_evalcode
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class submission_duplicated extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissionduplicated', 'mod_evalcode');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $this->set_legacy_logdata('submissioncopied', $this->evalcode->format_submission_for_log($submission));
