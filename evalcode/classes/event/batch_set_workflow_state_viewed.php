...
/**
 * The mod_evalcode evalcodeframework batch set workflow stated viewed event.
 *
...
class batch_set_workflow_state_viewed extends base {
    ...
    public static function get_name() {
        return get_string('eventbatchsetworkflowstateviewed', 'mod_evalcode');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' viewed the batch set workflow for the evalcodeframework with course " .
    ...
    protected function get_legacy_logdata() {
        $logmessage = get_string('viewbatchsetmarkingworkflowstate', 'evalcode');
    ...
    protected function validate_data() {
        if (self::$preventcreatecall) {
            throw new \coding_exception('cannot call batch_set_workflow_state_viewed::create() directly, use batch_set_workflow_state_viewed::create_from_evalcode() instead.');
        }
