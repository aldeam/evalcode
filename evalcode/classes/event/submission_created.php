...
/**
 * The mod_evalcode submission_created abstract event.
 *
...
/**
 * The mod_evalcode submission_created abstract event class.
 *
...
abstract class submission_created extends base {
    ...
    public static function get_name() {
        return get_string('eventsubmissioncreated', 'mod_evalcode');
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['submissionid'] = array('db' => 'eval_submission', 'restore' => 'submission');
