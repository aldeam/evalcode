...
/**
 * The mod_evalcode submission status updated event.
 *
...
/**
 * The mod_evalcode submission status updated event class.
 *
...
class submission_status_updated extends base {
    ...
    public static function create_from_submission(\evalcode $evalcode, \stdClass $submission) {
        $data = array(
            ...
            'relateduserid' => ($evalcode->get_instance()->teamsubmission) ? null : $submission->userid,
            'other' => array(
    ...
    public function get_description() {
        return "The user with id '$this->userid' has updated the status of the submission with id '$this->objectid' for " .
            "the evalcodeframework with course module id '$this->contextinstanceid' to the status '{$this->other['newstatus']}'.";
    }
    ...
    public static function get_name() {
        return get_string('eventsubmissionstatusupdated', 'mod_evalcode');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        $logmessage = get_string('reverttodraftforstudent', 'evalcode', array('id' => $user->id, 'fullname' => fullname($user)));
