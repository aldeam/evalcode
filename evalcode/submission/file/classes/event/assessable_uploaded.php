...
/**
 * The evalsubmission_file assessable uploaded event.
 *
...
/**
 * The evalsubmission_file assessable uploaded event class.
 *
 * @package    evalsubmission_file
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public function get_description() {
        return "The user with id '$this->userid' has uploaded a file to the submission with id '$this->objectid' " .
            "in the evalcodeframework activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'evalsubmission_file');
    }
