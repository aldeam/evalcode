...
/**
 * Strings for component 'evalsubmission_file', language 'en'
 *
...
$string['default_help'] = 'If set, this submission method will be enabled by default for all new evalcodeframeworks.';
...
$string['maxfiles_help'] = 'If file submissions are enabled, each evalcodeframework can be set to accept up to this number of files for their submission.';
