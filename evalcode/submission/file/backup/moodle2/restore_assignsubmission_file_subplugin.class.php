 ...
 * needed to restore one eval_submission subplugin.
 *
 * @package evalsubmission_file
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_evalsubmission_file_subplugin extends restore_subplugin {
     ...
     * @return void
     */
    public function process_evalsubmission_file_submission($data) {
        global $DB;
        ...
        $DB->insert_record('evalsubmission_file', $data);

        $this->add_related_files('evalsubmission_file',
                                 'submission_files',
                                 'submission',
                                 null,
                                 $oldsubmissionid);
