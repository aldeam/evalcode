 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class eval_submission_comments extends eval_submission_plugin {
    ...
    public function get_name() {
        return get_string('pluginname', 'evalsubmission_comments');
    }
    ...
    public function view_summary(stdClass $submission, & $showviewlink) {
        ...
        $options->course    = $this->evalcodeframework->get_course();
        $options->context = $this->evalcodeframework->get_context();
        ...
        $o = $this->evalcodeframework->get_renderer()->container($comment->output(true), 'commentscontainer');
        return $o;
    }
    ...
    public function upgrade_settings(context $oldcontext, stdClass $oldevalcodeframework, & $log) {
        if ($oldevalcodeframework->evalcodeframeworktype == 'upload') {
            // Disable if allow notes was not enabled.
            if (!$oldevalcodeframework->var2) {
                $this->disable();
            }
        }
        return true;
