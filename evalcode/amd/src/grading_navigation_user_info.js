 ...
 *
 * @module     mod_evalcode/grading_navigation_user_info
...
define(['jquery', 'core/notification', 'core/ajax', 'core/templates'], function($, notification, ajax, templates) {
    ...
    /**
     * Get the evalcodeframework id
     *
     * @private
     * @method _getEvalCodeId
     * @return int evalcodeframework id
     */
    UserInfo.prototype._getEvalCodeId = function() {
        return this._region.attr('data-evalcodeframeworkid');
    };
    ...
    UserInfo.prototype._refreshUserInfo = function(event, userid) {
        ...
        templates.render('mod_evalcode/loading', {}).done(function(html, js) {
            ...
            if (userid < 0) {
                // Render the template.
                templates.render('mod_evalcode/grading_navigation_no_users', {}).done(function(html, js) {
                    // Update the page.
                    this._region.fadeOut("fast", function() {
                        templates.replaceNodeContents(this._region, html, js);
                        this._region.fadeIn("fast");
            ...
            if (typeof this._userCache[userid] !== "undefined") {
                ...
                var evalcodeframeworkId = this._getEvalCodeId();
                var requests = ajax.call([{
                    methodname: 'mod_evalcode_get_participant',
                    args: {
                        userid: userid,
                        evalcodeid: evalcodeframeworkId,
                        embeduser: true
                    }
                }]);
            ...
            promise.done(function(context) {
                ...
                templates.render('mod_evalcode/grading_navigation_user_summary', context).done(function(html, js) {
                    // Update the page.
                    this._region.fadeOut("fast", function() {
                        templates.replaceNodeContents(this._region, html, js);
                        this._region.fadeIn("fast");
