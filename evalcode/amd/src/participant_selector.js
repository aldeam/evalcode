...
/**
 * Custom auto-complete adapter to load users from the evalcodeframework list_participants webservice.
 *
 * @module     mod_evalcode/participants_selector
...
define(['core/ajax', 'jquery', 'core/templates'], function(ajax, $, templates) {
    ...
    return /** @alias module:mod_evalcode/participants_selector */ {
        ...
        transport: function(selector, query, success, failure) {
            var evalcodeframeworkid = $(selector).attr('data-evalcodeframeworkid');
            ...
            var promise = ajax.call([{
                methodname: 'mod_evalcode_list_participants', args: { evalcodeid: evalcodeframeworkid, groupid: 0, filter: query, limit: 30 }
            }]);
            ...
            promise[0].then(function(results) {
                ...
                $.each(results, function(index, user) {
                    ...
                    if (show) {
                        ...
                        promises.push(templates.render('mod_evalcode/list_participant_user_summary', ctx));
                    }
                });
