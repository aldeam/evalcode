YUI.add('moodle-mod_evalcode-history', function (Y, NAME) {

// Define a function that will run in the context of a
// Node instance:
var CSS = {
        LINK: 'mod-evalcode-history-link',
        OPEN: 'mod-evalcode-history-link-open',
        CLOSED: 'mod-evalcode-history-link-closed',
        PANEL: 'mod-evalcode-history-panel'
    },
    COUNT = 0,
    TOGGLE = function() {
        var id = this.get('for'),
