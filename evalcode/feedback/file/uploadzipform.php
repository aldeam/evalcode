 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class evalfeedback_file_upload_zip_form extends moodleform {
    /**
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'uploadzip', get_string('uploadzip', 'evalfeedback_file'));
        ...
        $mform->addHelpButton('feedbackzip', 'feedbackzip', 'evalfeedback_file');
        ...
        $this->add_action_buttons(true, get_string('importfeedbackfiles', 'evalfeedback_file'));
