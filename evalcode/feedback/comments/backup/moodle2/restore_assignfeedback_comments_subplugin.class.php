 ...
 *
 * Provides the necessary information needed to restore
 * one evalfeedback subplugin.
 *
 * @package   evalfeedback_comments
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_evalfeedback_comments_subplugin extends restore_subplugin {
     ...
     * @param mixed $data
     */
    public function process_evalfeedback_comments_grade($data) {
        global $DB;
        ...
        $DB->insert_record('evalfeedback_comments', $data);
    }
}
