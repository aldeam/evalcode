...
/**
 * Strings for component 'evalfeedback_comments', language 'en'
 *
...
$string['commentinlinedefault_help'] = 'If set, this comment inline functionality will be enabled by default for all new evalcodeframeworks.';
