 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class eval_submission_plugin extends evalcode_plugin {
     ...
     * @param stdClass $submission the eval_submission record being submitted.
     ...
     *
     * @param stdClass|false $submission - eval_submission data if any
     ...
     *
     * @param stdClass $submission - eval_submission data
     * @return void
     */
