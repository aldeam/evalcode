...
require_once($CFG->dirroot.'/mod/evalcode/evalcodeframeworkplugin.php');

/**
 * Abstract class for feedback_plugin inherited from evalcode_plugin abstract class.
 *
 * @package   mod_evalcode
 * @copyright 2012 NetSpot {@link http://www.netspot.com.au}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
abstract class eval_feedback_plugin extends evalcode_plugin {
     ...
     *
     * A grading action is a page that is not specific to a user but to the whole evalcodeframework.
     * @return array - An array of action and description strings.
